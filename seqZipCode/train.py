...
#Generate output size for each conv2d layer
...
data_eval = np.loadtxt('dataset/eval_data.csv', delimiter=' ', dtype='float32')
lab_eval  = np.genfromtxt('dataset/eval_label.csv', dtype='unicode', delimiter='\n')
